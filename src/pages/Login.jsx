...
const Login = () => {
  ...
  return (
    <div className="bg-animate min-h-screen flex items-center justify-center p-4 signup-bg-img">
      <div className="bg-opacity-30 bg-green-900 p-8 rounded-3xl shadow-2xl transform hover:scale-105 transition-all duration-500 w-2/5">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col space-y-2">
           { <button
            ...
            >
              {loading ? <div className="inline-block h-6 w-6 animate-spin rounded-full border-b-2 border-gray-900 border-t-2 "></div>: "Login"}
            </button>}
